...
var r = (t, i, n) => i in t ? g(t, i, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[i] = n, u = (t, i) => {
  for (var n in i || (i = {}))
    d.call(i, n) && r(t, n, i[n]);
  if (c)
    for (var n of c(i))
      s.call(i, n) && r(t, n, i[n]);
  return t;
}, k = (t, i) => h(t, x(i));
var y = (t, i) => {
  var n = {};
  for (var e in t)
    d.call(t, e) && i.indexOf(e) < 0 && (n[e] = t[e]);
  if (t != null && c)
    for (var e of c(t))
      i.indexOf(e) < 0 && s.call(t, e) && (n[e] = t[e]);
  return n;
};
var B = (t, i, n) => new Promise((e, a) => {
  var l = (o) => {
    try {
      f(n.next(o));
    } catch (m) {
...
const q = (i) => {
  ...
  return /* @__PURE__ */ b(
    ...
    k(u({
      ...
      onClick: (...a) => B(void 0, null, function* () {
